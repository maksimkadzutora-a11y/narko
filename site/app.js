/* ═══════════════════════════════════════════
   Антиспам: не более 5 отправок за 20 минут
   ═══════════════════════════════════════════ */
...
const PLACES = [
  { type:"лес",     icon:"🌲", price:1400 },
  { type:"больница",icon:"🏥", price:2100 },
  { type:"кафе",    icon:"☕", price:1900 },
  { type:"ресторан",icon:"🍽", price:2900 },
  { type:"пк клуб", icon:"🖥", price:2500 },
  { type:"кофейня", icon:"🧃", price:2200 },
];
